...
def main():
    base = '/home/z/my-project/scripts/regime'
    writer = PdfWriter()
    ...
    writer.add_metadata({
        ...
        '/Keywords': 'XAUUSD, regime detection, HMM, LightGBM, SHAP, ensemble, market state',
    })
    out = '/home/z/my-project/download/TITAN_Adaptive_Regime_Detection_System_v1.0.pdf'
