...
const DIR = '/home/z/my-project/scripts/stress/diagrams';
const OUT = '/home/z/my-project/scripts/stress/diagrams/png';
if (!fs.existsSync(OUT)) fs.mkdirSync(OUT, { recursive: true });
const diagrams = [
  { html: 'd01_scenarios.html',        png: 'd01_scenarios.png',        w: 1600, h: 1200 },
  { html: 'd02_scenario_detail.html',  png: 'd02_scenario_detail.png',  w: 1600, h: 1200 },
  { html: 'd03_recovery.html',         png: 'd03_recovery.png',         w: 1600, h: 1100 },
  { html: 'd04_failure.html',          png: 'd04_failure.png',          w: 1600, h: 1100 },
  { html: 'd05_certification.html',    png: 'd05_certification.png',    w: 1600, h: 1100 },
];
(async () => {
  ...
  await browser.close(); console.log('\nAll stress testing diagrams rendered.');
})();
