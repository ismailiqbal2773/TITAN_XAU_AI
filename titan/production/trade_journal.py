...
class EventType(str, Enum):
    ...
    # ─── Sprint 9.9.3.44.3: MT5 tick SL/TP fallback events ─────────────
    DEMO_MICRO_MT5_TICK_FALLBACK_USED = "DEMO_MICRO_MT5_TICK_FALLBACK_USED"
    DEMO_MICRO_REFERENCE_PRICE_MISSING = "DEMO_MICRO_REFERENCE_PRICE_MISSING"
    DEMO_MICRO_STOP_LEVEL_VALIDATED = "DEMO_MICRO_STOP_LEVEL_VALIDATED"
    DEMO_MICRO_STOP_LEVEL_BLOCKED = "DEMO_MICRO_STOP_LEVEL_BLOCKED"

    # ─── Sprint 9.9.3.44.4: Local operator execution events ───────────
    DEMO_MICRO_LOCAL_TOKEN_CREATED = "DEMO_MICRO_LOCAL_TOKEN_CREATED"
    DEMO_MICRO_LOCAL_TOKEN_EXPIRED = "DEMO_MICRO_LOCAL_TOKEN_EXPIRED"
    DEMO_MICRO_LOCAL_TOKEN_CONSUMED = "DEMO_MICRO_LOCAL_TOKEN_CONSUMED"
    DEMO_MICRO_LOCAL_OPERATOR_CONFIRMED = "DEMO_MICRO_LOCAL_OPERATOR_CONFIRMED"
    DEMO_MICRO_ORDER_SEND_ATTEMPTED = "DEMO_MICRO_ORDER_SEND_ATTEMPTED"
    DEMO_MICRO_ORDER_SEND_SUCCEEDED = "DEMO_MICRO_ORDER_SEND_SUCCEEDED"
    DEMO_MICRO_ORDER_SEND_FAILED = "DEMO_MICRO_ORDER_SEND_FAILED"
    DEMO_MICRO_POST_TRADE_VERIFIED = "DEMO_MICRO_POST_TRADE_VERIFIED"
    DEMO_MICRO_POST_TRADE_WARNING = "DEMO_MICRO_POST_TRADE_WARNING"

    # ─── Sprint 9.9.3.45: Forensics and trailing protection events ────
    DEMO_MICRO_FORENSICS_COLLECTED = "DEMO_MICRO_FORENSICS_COLLECTED"
    DEMO_MICRO_TRAILING_READY = "DEMO_MICRO_TRAILING_READY"
    DEMO_MICRO_TRAILING_BLOCKED = "DEMO_MICRO_TRAILING_BLOCKED"
    DEMO_MICRO_BREAKEVEN_TRIGGERED = "DEMO_MICRO_BREAKEVEN_TRIGGERED"
    DEMO_MICRO_TRAILING_TRIGGERED = "DEMO_MICRO_TRAILING_TRIGGERED"
    DEMO_MICRO_PROFIT_LOCK_TRIGGERED = "DEMO_MICRO_PROFIT_LOCK_TRIGGERED"
    DEMO_MICRO_SL_MODIFY_PREVIEW_BUILT = "DEMO_MICRO_SL_MODIFY_PREVIEW_BUILT"
    DEMO_MICRO_SL_MODIFY_ATTEMPTED = "DEMO_MICRO_SL_MODIFY_ATTEMPTED"
    DEMO_MICRO_SL_MODIFY_SUCCEEDED = "DEMO_MICRO_SL_MODIFY_SUCCEEDED"
    DEMO_MICRO_SL_MODIFY_FAILED = "DEMO_MICRO_SL_MODIFY_FAILED"

    # ─── Sprint 9.9.3.45.1: Managed trade orchestration events ────────
    DEMO_MICRO_MANAGED_TRADE_CHECKED = "DEMO_MICRO_MANAGED_TRADE_CHECKED"
    DEMO_MICRO_MANAGED_TRADE_ARMED = "DEMO_MICRO_MANAGED_TRADE_ARMED"
    DEMO_MICRO_MANAGED_TRADE_STARTED = "DEMO_MICRO_MANAGED_TRADE_STARTED"
    DEMO_MICRO_MANAGED_TRADE_BLOCKED = "DEMO_MICRO_MANAGED_TRADE_BLOCKED"
    DEMO_MICRO_MANAGED_TRADE_COMPLETED = "DEMO_MICRO_MANAGED_TRADE_COMPLETED"
    DEMO_MICRO_MONITOR_STARTED = "DEMO_MICRO_MONITOR_STARTED"
    DEMO_MICRO_MONITOR_STOPPED = "DEMO_MICRO_MONITOR_STOPPED"
    DEMO_MICRO_POSITION_DETECTED = "DEMO_MICRO_POSITION_DETECTED"
